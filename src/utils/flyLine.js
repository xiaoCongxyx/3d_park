...
class FlyLine {
    ...
    constructor(opts) {
        ...
        this.v0 = opts.v0 || new THREE.Vector3(0, 0, 0)
        this.v1 = opts.v1 || new THREE.Vector3(0, 0, 0)
        this.speed = opts.speed / 100 || 0.01;
        this.el = opts.el || "";
        this.scene = opts.scene || "";
        this.type = opts.type || 'run'
    ...
    createLine() {
        ...
        textureLoader.load(this.img,
            texture => {
                this.texture = texture
                this.texture.anisotropy = 16; // 沿着轴，通过具有最高纹素密度的像素的样本数。
    ...
    createAnimateLine(option) {
        ...
        let { sphereHeightPointsArgs } = option
